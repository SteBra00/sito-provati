    ...
    <main>
        ...
        <?php
            if($user['linkInstagram']!='') {
                echo '<a href="'.$user['linkInstagram'].'" class="link-social"><i class="fa-brands fa-instagram"></i></a>';
            }
            if($user['linkFacebook']!='') {
                echo '<a href="'.$user['linkFacebook'].'" class="link-social"><i class="fa-brands fa-facebook"></i></a>';
            }
            if($user['linkTelegram']!='') {
                echo '<a href="'.$user['linkTelegram'].'" class="link-social"><i class="fa-brands fa-telegram"></i></a>';
            }
            if($user['linkSnapchat']!='') {
                echo '<a href="'.$user['linkSnapchat'].'" class="link-social"><i class="fa-brands fa-snapchat"></i></a>';
            }
            if($user['linkTwitter']!='') {
                echo '<a href="'.$user['linkTwitter'].'" class="link-social"><i class="fa-brands fa-twitter"></i></a>';
            }
        ?>
